export default function learnpage() {
    return (
        ...
        <div className="bg-purple-300 p-6 h-72 w-96 rounded-4xl flex flex-col justify-between text-blue-950">
         ...
         <div className="bg-orange-300 p-6 h-72 w-96 rounded-4xl flex flex-col justify-between text-blue-950">
            <div className="flex gap-2">
         ...
         <div className="bg-red-300 p-6 h-72 w-96 rounded-4xl flex flex-col justify-between text-blue-950">
            <div className="flex gap-2">
                <img src="palette.svg" alt="Design"/>
                <p className="font-bold">Design</p>
            </div>
